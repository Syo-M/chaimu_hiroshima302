...
c_btn.addEventListener("click", function () {
    ...
    setAlarm(
        alarmHours[0],
        alarmMinutes[2],
        alarmHours[0] + "時" + alarmMinutes[2] + "分" + "です。" + "1限目始まるよ。",
        chime
    );
    setAlarm(
        alarmHours[1],
    ...
    setAlarm(
        alarmHours[1],
        alarmMinutes[2],
        alarmHours[1] + "時" + alarmMinutes[2] + "分" + "です。" + "2限目始まるよ。",
        chime
    );
    setAlarm(
        alarmHours[2],
    ...
    setAlarm(
        alarmHours[2],
        alarmMinutes[2],
        alarmHours[2] + "時" + alarmMinutes[2] + "分" + "です。" + "3限目始まるよ。",
        chime
    );
    setAlarm(
        alarmHours[3],
    ...
    setAlarm(
        alarmHours[4],
        alarmMinutes[1],
        alarmHours[4] + "時" + alarmMinutes[1] + "分" + "です。" + "4限目始まるよ。",
        chime
    );
    setAlarm(
        alarmHours[5],
    ...
    setAlarm(
        alarmHours[5],
        alarmMinutes[1],
        alarmHours[5] + "時" + alarmMinutes[1] + "分" + "です。" + "5限目始まるよ。",
        chime
    );
    setAlarm(
        alarmHours[6],
    ...
    setAlarm(
        alarmHours[6],
        alarmMinutes[1],
        alarmHours[6] + "時" + alarmMinutes[1] + "分" + "です。" + "6限目始まるよ。",
        chime
    );
    setAlarm(
        alarmHours[7],
        ...
        alarmHours[7] +
            ...
            "分" +
            "です。" +
            "6限目終了。本日の授業終了です。お疲れ様でした。放課後は1時間自習ができます。",
        chime
    );
    setAlarm(alarmHours[8], alarmMinutes[3], "自習タイム終了。また次の授業でお会いしましょう。", closed);
});
